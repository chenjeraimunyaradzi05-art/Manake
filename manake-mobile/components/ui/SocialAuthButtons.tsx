...
export function SocialIconButton({ provider, onPress, style, disabled, loading }: SocialIconButtonProps) {
...
export function SocialAuthButtons({ onProviderPress, style, disabled, loadingProvider }: SocialAuthButtonsProps) {
  const handlePress = (provider: SocialProvider) => () => onProviderPress?.(provider);
