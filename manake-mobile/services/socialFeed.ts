...
export async function getInstagramFeed(
  ...
  return fetchApi<SocialFeedResponse>(
    `/social/instagram/feed?${params.toString()}`,
  );
}
...
export async function getFacebookFeed(
  ...
  return fetchApi<SocialFeedResponse>(
    `/social/facebook/feed?${params.toString()}`,
  );
}
...
export async function getTwitterFeed(
  ...
  return fetchApi<SocialFeedResponse>(
    `/social/twitter/feed?${params.toString()}`,
  );
}
...
export async function likeSocialPost(
  ...
  await fetchApi(`/social/${platform}/posts/${postId}/like`, {
    method: "POST",
  });
}
...
export async function shareSocialPost(
  ...
  await fetchApi(`/social/${platform}/posts/${postId}/share`, {
    method: "POST",
  });
}
