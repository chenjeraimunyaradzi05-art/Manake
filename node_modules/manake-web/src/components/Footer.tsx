        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-center gap-3 mb-6">
              ...
              <div>
                <span className="font-display font-bold text-xl text-white block">Manake</span>
                <span className="text-sm text-gray-400">Rehabilitation Center</span>
              </div>
            </Link>
            <p className="text-gray-400 mb-6 leading-relaxed">
              Transforming lives through recovery, education, and hope. 
              Empowering Zimbabwe's youth to overcome addiction and build brighter futures.
            </p>
          ...
          {/* Support */}
          <div>
            <h4 className="font-display font-bold text-white text-lg mb-6">Support Us</h4>
            <ul className="space-y-3">
