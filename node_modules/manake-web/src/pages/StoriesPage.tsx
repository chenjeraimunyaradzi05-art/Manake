      ...
      <section className="bg-gradient-to-r from-primary-600 to-primary-800 text-white py-16">
        <div className="container-custom">
          ...
          <p className="text-xl text-primary-100 max-w-2xl">
            Real stories of transformation, hope, and new beginnings. Each journey is unique, 
            but they all share one thing: the courage to change.
          </p>
        </div>
      </section>
        ...
        <div className="container-custom">
          <div className="bg-gradient-to-r from-primary-50 to-secondary-50 rounded-3xl p-8 md:p-12 text-center">
            ...
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              If you're a Manake graduate and want to share your story to inspire others, 
              we'd love to hear from you. Your journey could be the hope someone needs today.
            </p>
