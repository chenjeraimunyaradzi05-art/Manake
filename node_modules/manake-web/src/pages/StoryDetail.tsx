...
export const StoryDetail = () => {
  ...
  const handleShare = (platform: 'whatsapp' | 'facebook' | 'twitter' | 'copy') => {
    ...
    const text = story ? `Check out "${story.title}" - Manake Rehabilitation Center` : '';
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <article className="lg:col-span-2">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 mt-8">
                ...
                <div className="space-y-6">
                  {[
                    { author: 'Sarah M.', comment: 'Such an inspiring story! Gives me hope for my brother who is struggling.', time: '2 days ago' },
                    { author: 'John K.', comment: 'Manake truly does amazing work. Keep it up!', time: '1 week ago' },
                  ].map((comment, index) => (
                    <div key={index} className="border-b pb-4 last:border-0">
                      <div className="flex items-center gap-3 mb-2">
                        <div className="w-10 h-10 bg-primary-100 rounded-full flex items-center justify-center">
                          <span className="text-primary-600 font-bold">{comment.author[0]}</span>
                        </div>
                        <div>
            ...
            <aside className="space-y-8">
              ...
              <div className="bg-gradient-to-br from-primary-600 to-primary-800 text-white rounded-2xl p-6">
                <h3 className="text-xl font-bold mb-3">Support Stories Like This</h3>
                <p className="text-primary-100 mb-4">
                  Your donation helps more youth write their own recovery story.
                </p>
                <Link to="/donate" className="btn-primary bg-white text-primary-700 hover:bg-primary-50 w-full">
                  <Heart size={18} />
                  Donate Now
                </Link>
              </div>
              ...
              <div className="bg-red-50 border border-red-200 rounded-2xl p-6">
                <h3 className="font-bold text-lg text-red-800 mb-3">Need Help?</h3>
