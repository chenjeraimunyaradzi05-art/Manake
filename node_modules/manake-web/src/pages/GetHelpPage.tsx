...
export const GetHelpPage = () => {
  const steps = [
    {
      title: 'Reach Out',
      description: 'Call, WhatsApp, or submit the confidential form. A real human responds.',
      icon: <Phone className="w-6 h-6" />,
    },
    {
      title: 'Assessment',
      description: 'A counselor assesses urgency, safety, and recommends next steps within 24 hours.',
      icon: <Shield className="w-6 h-6" />,
    },
    {
      title: 'Plan & Care',
      description: 'We create a recovery plan with you: residential care, outpatient, or referrals.',
      icon: <Heart className="w-6 h-6" />,
    },
    {
      title: 'Life Skills',
      description: 'Training, mentorship, and family support so you do not fall back into addiction.',
    ...
    <>
      ...
      <section className="bg-gradient-to-r from-red-600 to-primary-800 text-white py-16">
        <div className="container-custom">
          <p className="text-sm uppercase tracking-wide text-red-100 mb-3">You are not alone</p>
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Get Help Now</h1>
          <p className="text-lg text-red-100 max-w-2xl">
            Confidential, judgment-free support for youth in Zimbabwe battling drug and alcohol addiction. Contact us anytime—day or night.
          </p>
          <div className="flex flex-wrap gap-3 mt-6">
            <a href="tel:+263775772277" className="btn-emergency">
              <Phone size={18} /> Call +263 77 577 2277
            </a>
            <a href="https://wa.me/263775772277?text=I%20need%20help%20urgently" className="btn-secondary bg-white text-primary-700">
        ...
        <div className="container-custom grid md:grid-cols-3 gap-6">
          {crisisContacts.map((c) => (
            ...
            >
              ...
              <p className="text-sm text-white/90">Immediate, confidential support</p>
            </a>
          ))}
        </div>
      </section>
        ...
        <div className="container-custom">
          <div className="text-center mb-10">
            ...
            <p className="section-subheading mx-auto">
              Simple, human, judgment-free. We focus on safety first, then recovery and life skills.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {steps.map((step, idx) => (
              <div key={idx} className="card-hover p-6 h-full flex flex-col gap-3">
        ...
        <div className="container-custom grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="text-lg text-gray-600 mb-6">
              Residential recovery, outpatient support, family counseling, and life skills training ensure you stay free from addiction and build a stable future.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            <h3 className="text-xl font-bold mb-4">Request Confidential Help</h3>
            <p className="text-gray-600 mb-4">Share basic details; we respond within 24 hours.</p>
