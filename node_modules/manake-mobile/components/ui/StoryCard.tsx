...
export function StoryCard({ story, onPress, variant = 'default' }: StoryCardProps) {
  ...
  if (variant === 'featured') {
    return (
      <TouchableOpacity onPress={onPress} style={styles.featuredCard} activeOpacity={0.7}>
    ...
    <TouchableOpacity onPress={onPress} style={styles.card} activeOpacity={0.7}>
      ...
      <View style={styles.content}>
        <View style={styles.tagRow}>
          <View style={[styles.tag, { backgroundColor: getCategoryColor(story.category) }]}>
        ...
        <View style={styles.footer}>
          ...
          <View style={styles.statsRow}>
            <FontAwesome 
              ...
              size={14} 
              color={story.isLiked ? theme.colors.danger : theme.colors.textLight} 
            />
            <Text style={styles.statText}>{story.likes}</Text>
            <FontAwesome name="comment-o" size={14} color={theme.colors.textLight} style={{ marginLeft: 12 }} />
