      ...
      <View style={styles.section}>
        ...
        <Card variant="elevated" style={styles.programsCard}>
          <View style={styles.programItem}>
            <View
              style={[styles.programIcon, { backgroundColor: "#10b98115" }]}
            >
          ...
          <View style={styles.programItem}>
            <View
              style={[styles.programIcon, { backgroundColor: "#3b82f615" }]}
            >
          ...
          <View style={styles.programItem}>
            <View
              style={[styles.programIcon, { backgroundColor: "#8b5cf615" }]}
            >
          ...
          <View style={styles.ctaContent}>
            <View style={styles.ctaTextContainer}>
              ...
              <Text style={styles.ctaDescription}>
                Your donation helps transform lives and restore hope to
                families.
              </Text>
            </View>
            <Button
