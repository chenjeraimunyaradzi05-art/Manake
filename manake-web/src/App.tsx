...
const StoryDetail = lazy(() =>
  import("./pages/StoryDetail").then((m) => ({ default: m.StoryDetail })),
);
const DonatePage = lazy(() =>
  import("./pages/DonatePage").then((m) => ({ default: m.DonatePage })),
);
const GetHelpPage = lazy(() =>
  import("./pages/GetHelpPage").then((m) => ({ default: m.GetHelpPage })),
);
...
const SocialCallbackPage = lazy(() =>
  import("./pages/SocialCallbackPage").then((m) => ({
...
const CommunityPostDetailPage = lazy(() =>
  import("./pages/CommunityPostDetailPage").then((m) => ({
          ...
          <div className="min-h-screen flex flex-col bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-indigo-50 via-rose-50 to-amber-50 dark:from-cosmic-950 dark:via-purple-950 dark:to-slate-900">
            ...
            <div className="flex flex-grow w-full">
              ...
              <main
                ...
                className="flex-1 min-h-screen transition-all duration-300 pt-6 px-0"
              >
