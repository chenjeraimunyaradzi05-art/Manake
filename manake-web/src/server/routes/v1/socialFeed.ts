...
router.post('/:platform/posts/:postId/like', optionalAuth, asyncHandler(likeSocialPost));
router.delete('/:platform/posts/:postId/like', optionalAuth, asyncHandler(unlikeSocialPost));
router.post('/:platform/posts/:postId/share', optionalAuth, asyncHandler(shareSocialPost));
