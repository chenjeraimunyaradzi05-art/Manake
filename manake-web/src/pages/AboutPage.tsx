  ...
  const values = [
    {
      ...
      title: "Compassion",
      text: "We meet every youth with empathy and dignity.",
    },
    {
      icon: <Target className="w-6 h-6" />,
      title: "Results",
      text: "Evidence-based care with measurable outcomes.",
    },
    {
      icon: <Leaf className="w-6 h-6" />,
      title: "Hope",
      text: "Recovery is possible; we walk the journey together.",
    },
    {
      icon: <Globe2 className="w-6 h-6" />,
      title: "Community",
      text: "Family, peers, and partners are part of healing.",
    },
  ];
      ...
      <section className="bg-gradient-to-r from-primary-700 to-primary-900 text-white py-16">
        <div className="container-custom">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            About Manake Rehabilitation Center
          </h1>
          <p className="text-lg text-primary-100 max-w-2xl">
            Empowering youth in Zimbabwe to overcome drug and alcohol addiction
            through recovery, life skills, and community support.
          </p>
        </div>
      </section>
        ...
        <div className="container-custom grid md:grid-cols-2 gap-10 items-start">
          <div className="bg-primary-50 border border-primary-100 rounded-2xl p-8 shadow-sm">
            ...
            <p className="text-gray-700 leading-relaxed">
              To provide youth-focused, evidence-based rehabilitation that
              restores dignity, rebuilds families, and equips young people with
              life skills to thrive beyond addiction.
            </p>
          </div>
          <div className="bg-secondary-50 border border-secondary-100 rounded-2xl p-8 shadow-sm">
            ...
            <p className="text-gray-700 leading-relaxed">
              A Zimbabwe where every young person struggling with addiction has
              a clear path to recovery, purpose, and meaningful contribution to
              society.
            </p>
          </div>
        </div>
        ...
        <div className="container-custom">
          <div className="text-center mb-10">
            ...
            <p className="section-subheading mx-auto">
              Formerly known as TODAY'S WOMEN OF TRAFALGAR, MET is a Zimbabwean
              community-based organization active in Norton, Mashonaland West.
              It advances social and economic development by empowering
              vulnerable groups — including women, youth, and people recovering
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              ...
              <ul className="space-y-3 text-gray-700">
                <li>
                  ...
                  Entrepreneurship and vocational training that equips community
                  members with income-generating skills. In November 2025, MET
                  held a graduation for 300+ program completers.
                </li>
                <li>
                  <span className="font-semibold">Substance Abuse Reform:</span>{" "}
                  A recognized partner of the Zimbabwean government in combating
                  drug and substance abuse. In early 2025, MET was commended for
                  training 240+ drug abuse reformers in life-changing skills.
                </li>
                <li>
                  <span className="font-semibold">
                    Gender-Based Violence (GBV) Advocacy:
                  </span>{" "}
                  Community campaigns that address GBV and its links to broader
                  social challenges, including substance abuse.
                </li>
                <li>
                  <span className="font-semibold">Product Showcasing:</span>{" "}
                  Graduates showcase and market products developed through their
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                MET’s initiatives align with Zimbabwe’s Vision 2030 roadmap. The
                trust frequently collaborates with the Ministry of Women
                Affairs, Community, Small and Medium Enterprises Development,
                with national and local leaders often officiating at graduations
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-2xl p-5">
                ...
                <p className="text-gray-700">
                  A stronger pipeline from recovery to reintegration: practical
                  skills, safer communities, and partnerships that support
      ...
      <section className="py-16 bg-white">
        <div className="container-custom grid md:grid-cols-4 gap-6">
          {milestones.map((m, idx) => (
            <div
              key={idx}
              className="text-center bg-gray-50 rounded-2xl p-6 shadow-sm"
            >
      ...
      <section className="py-16 bg-gray-50">
        <div className="container-custom">
          <div className="text-center mb-10">
            ...
            <p className="section-subheading mx-auto">
              Licensed counselors, social workers, life skills trainers, and
              peer mentors.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              {
                name: "Dr. Tawanda Moyo",
                role: "Clinical Lead",
                desc: "Oversees medical protocols and mental health.",
              },
              {
                name: "Chipo Ncube",
                role: "Life Skills Lead",
                desc: "Designs vocational and entrepreneurship training.",
              },
              {
                name: "Farai Chitsiko",
                role: "Peer Support Coordinator",
                desc: "Alumnus who runs weekly peer groups.",
              },
              {
                name: "Memory Dube",
                role: "Family Therapist",
                desc: "Guides family reintegration and counseling.",
              },
              {
                name: "Blessing Zhou",
                role: "Programs & M&E",
                desc: "Tracks impact metrics and reporting.",
              },
            ].map((member, idx) => (
      ...
      <section className="py-12 bg-white">
        <div className="container-custom flex flex-col items-center gap-4 text-center">
          ...
          <p className="text-gray-600 max-w-2xl">
            Registered non-profit in Zimbabwe. Follows WHO-aligned substance use
            treatment guidelines. Data privacy and safeguarding policies in
            place for youth.
          </p>
        </div>
      </section>
